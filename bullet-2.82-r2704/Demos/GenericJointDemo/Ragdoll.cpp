	...
	btScalar scale_ragdoll)	: m_ownerWorld (ownerWorld)
{
	...
	// Setup the geometry
	m_shapes[BODYPART_PELVIS] = new btBoxShape(btVector3(scale_ragdoll*0.16f,scale_ragdoll*0.14f,scale_ragdoll*0.08f));
	m_shapes[BODYPART_SPINE] = new btBoxShape(btVector3(scale_ragdoll*0.16f,scale_ragdoll*0.23f,scale_ragdoll*0.08f));
	m_shapes[BODYPART_NECK] = new btBoxShape(btVector3(scale_ragdoll*0.062f,scale_ragdoll*0.04f,scale_ragdoll*0.062f));
	m_shapes[BODYPART_HEAD] = new btBoxShape(btVector3(scale_ragdoll*0.08f,scale_ragdoll*0.1f,scale_ragdoll*0.085f));

	m_shapes[BODYPART_LEFT_UPPER_LEG] = new btBoxShape(btVector3(scale_ragdoll*0.06f,scale_ragdoll*0.27f,scale_ragdoll*0.06f));
	// m_shapes[BODYPART_LEFT_UPPER_LEG] = new btCapsuleShape(btScalar(scale_ragdoll*0.07), btScalar(scale_ragdoll*0.45));
	m_shapes[BODYPART_LEFT_LOWER_LEG] = new btBoxShape(btVector3(scale_ragdoll*0.05f,scale_ragdoll*0.2f,scale_ragdoll*0.05f));
	m_shapes[BODYPART_LEFT_FOOT] = new btBoxShape(btVector3(0.2f,0.1f,0.5f));
	m_shapes[BODYPART_RIGHT_UPPER_LEG] = new btBoxShape(btVector3(scale_ragdoll*0.06f,scale_ragdoll*0.27f,scale_ragdoll*0.06f));
	m_shapes[BODYPART_RIGHT_LOWER_LEG] = new btBoxShape(btVector3(scale_ragdoll*0.05f,scale_ragdoll*0.2f,scale_ragdoll*0.05f));
	m_shapes[BODYPART_RIGHT_FOOT] = new btBoxShape(btVector3(0.2f,0.1f,0.5f));
	m_shapes[BODYPART_LEFT_UPPER_ARM] = new btBoxShape(btVector3(scale_ragdoll*0.05f,scale_ragdoll*0.2f,scale_ragdoll*0.05f));
	m_shapes[BODYPART_LEFT_LOWER_ARM] = new btBoxShape(btVector3(scale_ragdoll*0.045f,scale_ragdoll*0.16f,scale_ragdoll*0.045f));
	m_shapes[BODYPART_LEFT_HAND] = new btBoxShape(btVector3(0.1f,0.4f,0.2f));
	m_shapes[BODYPART_RIGHT_UPPER_ARM] = new btBoxShape(btVector3(scale_ragdoll*0.05f,scale_ragdoll*0.2f,scale_ragdoll*0.05f));
	m_shapes[BODYPART_RIGHT_LOWER_ARM] = new btBoxShape(btVector3(scale_ragdoll*0.045f,scale_ragdoll*0.16f,scale_ragdoll*0.045f));
	m_shapes[BODYPART_RIGHT_HAND] = new btBoxShape(btVector3(0.1f,0.4f,0.2f));
	...
	transform.setIdentity();
	transform.setOrigin(btVector3(btScalar(0.), btScalar(scale_ragdoll*1.5), btScalar(0.)));
...
btScalar(0.)));
	...
	transform.setIdentity();
	transform.setOrigin(btVector3(btScalar(-0.18*scale_ragdoll), btScalar(0.2*scale_ragdoll), btScalar(0.22)));
	...
	transform.setIdentity();
	transform.setOrigin(btVector3(btScalar(0.18*scale_ragdoll), btScalar(0.05*scale_ragdoll), btScalar(0.22)));
	...
	transform.setIdentity();
	transform.setOrigin(btVector3(btScalar(-0.9*scale_ragdoll), btScalar(1.45*scale_ragdoll), btScalar(0.)));
	transform.getBasis().setEulerZYX(0,0,SIMD_HALF_PI);
...
///////////////////////////// SETTING THE CONSTRAINTS /////////////////////////////////////////////7777
	...
	// joint6DOF->getRotationalLimitMotor();
	btTransform localA, localB;
	bool useLinearReferenceFrameA = true;
	// tmp->get
/// ******* SPINE NECK ******** ///
	{
		std::cout << "Starting to make hinge" << std::endl;
		localA.setIdentity(); localB.setIdentity();

		localA.setOrigin(btVector3(btScalar(0.), btScalar(0.16*scale_ragdoll), btScalar(0.)));

		localB.setOrigin(btVector3(btScalar(0.), btScalar(-0.1*scale_ragdoll), btScalar(0.)));

		// joint6DOF = new btPoint2PointConstraint(*m_bodies[BODYPART_SPINE], *m_bodies[BODYPART_NECK], localA, localB);
		btGeneric6DofConstraint * point2pointJoint = new btGeneric6DofConstraint(*m_bodies[BODYPART_SPINE], *m_bodies[BODYPART_NECK], localA, localB,useLinearReferenceFrameA);

		m_joints[JOINT_SPINE_NECK] = point2pointJoint;
		m_ownerWorld->addConstraint(m_joints[JOINT_SPINE_NECK], true);
		std::cout << "Done making hinge" << std::endl;
	}
/// *************************** ///
	...
	/// ******* LEFT HAND ******** ///
		{
			...
			localA.setOrigin(btVector3(btScalar(0.), btScalar(0.14*scale_ragdoll), btScalar(0.)));
			localB.setOrigin(btVector3(btScalar(0.), btScalar(-0.05*scale_ragdoll), btScalar(0.)));
			joint6DOF =  new btGeneric6DofConstraint (*m_bodies[BODYPART_LEFT_LOWER_ARM], *m_bodies[BODYPART_LEFT_HAND], localA, localB,useLinearReferenceFrameA);
			...
			joint6DOF->setAngularUpperLimit(btVector3(SIMD_PI*0.7f,SIMD_EPSILON,SIMD_EPSILON));
	#endif
			m_joints[JOINT_LEFT_WRIST] = joint6DOF;
	...
	/// ******* RIGHT HAND ******** ///
		{
			...
			localA.setOrigin(btVector3(btScalar(0.), btScalar(0.14*scale_ragdoll), btScalar(0.)));
			localB.setOrigin(btVector3(btScalar(0.), btScalar(-0.05*scale_ragdoll), btScalar(0.)));
			joint6DOF =  new btGeneric6DofConstraint (*m_bodies[BODYPART_RIGHT_LOWER_ARM], *m_bodies[BODYPART_RIGHT_HAND], localA, localB,useLinearReferenceFrameA);
...
/// *************************** ///
	...
	/// ******* LEFT FOOT ******** ///
		{
			...
			localA.setOrigin(btVector3(btScalar(0.), btScalar(-0.185*scale_ragdoll), btScalar(0.)));
			localB.setOrigin(btVector3(btScalar(0.), btScalar(0.05*scale_ragdoll), btScalar(0.22)));
	...
	//
			...
			joint6DOF->setAngularUpperLimit(btVector3(SIMD_PI*0.7f,SIMD_EPSILON,SIMD_EPSILON));
	#endif
			m_joints[JOINT_LEFT_ANKLE] = joint6DOF;
	...
	/// ******* RIGHT FOOT ******** ///
		{
			...
			joint6DOF->setAngularUpperLimit(btVector3(SIMD_PI*0.7f,SIMD_EPSILON,SIMD_EPSILON));
	#endif
			m_joints[JOINT_RIGHT_ANKLE] = joint6DOF;
