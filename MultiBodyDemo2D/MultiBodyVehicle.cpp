...
*/
    ...
    this->_root_Kp = 2.50f;
    this->_Kps[HIP_TO_LEFT_THIGH_JOINT] = 2.0f;
    this->_Kps[LEFT_THIGH_TO_LEFT_CHIN_JOINT] = 3.50f;
    this->_Kps[LEFT_CHIN_TO_LEFT_FOOT_JOINT] = 0.20f;
	...
	this->_Kds[LEFT_THIGH_TO_LEFT_CHIN_JOINT] = 1.250f;
